...
public class UploadGame extends HttpServlet {
        ...
        if (request.getParts() != null && request.getParts().size() > 0) {
            for (Part part : request.getParts()) {
                ...
                if (fileName != null && !fileName.equals("")) {
                    ...
                    if (isAllowedExtension(fileExtension) && isValidFileContent(part, fileExtension)) {
                        ...
                        g1.setImg(uniqueFileName);
                        message = message + fileName + "\n";
                    } else {
                        request.setAttribute("error", "Errore: Tipo di file non consentito o contenuto non valido.");
                    }
                } else {
    ...
    private boolean isValidFileContent(Part part, String extension) {
        try {
            // Semplice controllo del tipo MIME per esempio
